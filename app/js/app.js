...
var App = angular.module('angle', ['ngRoute', 'ngAnimate','ngMaterial', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'tmh.dynamicLocale', 'ui.utils','ngCookies'])
          .run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
              ...
              $rootScope.app = {
                ...
                server_url: 'http://localhost:3002',
                  //server_url: 'http://52.38.8.67:3001',
                description: 'ihealthkonnect Admin panel',
  ...
  $stateProvider
    ...
    .state('app.dashboard', {
      ...
      .state('app.reset_password', {
          ...
          templateUrl: helper.basepath('reset_password.html'),
          resolve: helper.resolveFor('flot-chart','flot-chart-plugins')
      })
      .state('app.customers', {
          url: '/customers',
      ...
      .state('app.serviceproviders', {
          ...
          templateUrl: helper.basepath('service_providers.html'),
          resolve: helper.resolveFor('flot-chart','flot-chart-plugins')
      })
    ...
    .state('app.sortable', {
      ...
      .state('app.order_details', {
          ...
          title: 'Order',
          templateUrl: helper.basepath('order_details.html')
      })
    ...
    .state('app.form-extended', {
        ...
        resolve: helper.resolveFor('codemirror', 'moment', 'taginput','inputmask','localytics.directives', 'slider', 'ngWig', 'filestyle')
    })
